...
def run_epoch(session, model, train_op=None, output_log=False):
    ...
    for step in range(model.epoch_size):
        ...
        for i, (c, h) in enumerate(model.initial_state):
            ...
            # print(type(state[i]))    <class 'tensorflow.python.ops.rnn_cell_impl.LSTMStateTuple'>
            # print(type(state[i].c))  <class 'numpy.ndarray'>
...
<<<<<<< HEAD
train_data, valid_data, test_data, _ = reader.ptb_raw_data("G:/学习/TensorFlow 深度学习算法原理与编程实践/simple-examples/simple-examples/data/")
=======
train_data, valid_data, test_data, _ = reader.ptb_raw_data("simple-examples/simple-examples/data/")
>>>>>>> first commit
